...
int MLIFE_TimeIterations( MLIFEPatchDesc *patch, int nIter, int doCheckpoint, int **m1, int **m2, 
			              ...
			              MLIFETiming *timedata )
{
    ...
    /* Pass the address of the first double in timedata - otherwise, the MPI implementation may warn about a mismatch in datatypes */
    MPI_Allreduce( MPI_IN_PLACE, &timedata->packtime, 4, MPI_DOUBLE, MPI_MAX, patch->comm );
